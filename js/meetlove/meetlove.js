...
#meetlove-app.mc-shell .mc-body{flex:1;overflow-y:auto;padding:4px 18px calc(env(safe-area-inset-bottom,0px) + 24px);display:flex;flex-direction:column;gap:14px}
#meetlove-app.mc-shell #mc-memory{display:flex;flex-direction:column;gap:16px;padding-bottom:10px}
...
#meetlove-app.mc-shell .hide{display:none!important}.mc-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.mc-card,.mc-stat,.mc-line,.mc-date,.mc-item,.mc-empty,.mc-load{background:rgba(255,255,255,.9);border-radius:22px;border:1px solid rgba(23,33,43,.06);box-shadow:0 16px 36px rgba(21,32,45,.07)}.mc-stat{padding:14px}.mc-stat-v{font-size:22px;font-weight:900;color:#17212b}.mc-stat-l{font-size:11px;color:#7c8792;margin-top:4px}.mc-card{padding:16px}.mc-sec-title{font-size:14px;font-weight:800;color:#17212b}.mc-sec-desc{font-size:11px;color:#768493;margin-top:3px;line-height:1.5}
#meetlove-app.mc-shell .mc-lines{display:flex;flex-direction:column;gap:10px;margin-top:12px}.mc-line{display:flex;gap:10px;align-items:flex-start;padding:12px 13px}.mc-line-tag{height:22px;padding:0 8px;border-radius:999px;background:#eef2f6;color:#5b6874;font-size:10px;font-weight:800;display:inline-flex;align-items:center;flex-shrink:0}.mc-line-text{font-size:12px;color:#4a5b69;line-height:1.65}
#meetlove-app.mc-shell .mc-timeline{display:flex;flex-direction:column;gap:12px;margin-top:12px}.mc-mini{padding:14px;border-radius:20px;background:#fff}.mc-mini-top{display:flex;justify-content:space-between;gap:12px}.mc-badge{display:inline-flex;align-items:center;height:22px;padding:0 9px;border-radius:999px;font-size:10px;font-weight:800}.mc-badge.sum{background:#eef4ff;color:#315fa3}.mc-badge.note{background:#f8f0de;color:#9a6720}.mc-meta{font-size:11px;color:#7a8795;margin-top:8px}.mc-mini-title{font-size:14px;font-weight:800;color:#17212b;margin-top:8px}.mc-mini-body{font-size:12px;line-height:1.75;color:#4a5a68;margin-top:8px}.mc-mini-act{display:flex;gap:8px;flex-shrink:0}.mc-act{height:28px;padding:0 10px;border-radius:10px;background:#f4f6f8;color:#566573;font-size:11px;font-weight:700}.mc-act.danger{background:#fff1f1;color:#c45656}
...
#meetlove-app.mc-shell .mc-editor{display:none;position:absolute;inset:0;background:rgba(8,13,18,.38);backdrop-filter:blur(10px);z-index:35;align-items:flex-end}.mc-editor.show{display:flex}.mc-editor-sheet{width:100%;background:#f9fbfd;border-radius:28px 28px 0 0;padding:14px 18px 18px}.mc-editor-top{display:flex;justify-content:space-between;align-items:center;padding-bottom:10px}.mc-editor-title{font-size:17px;font-weight:800;color:#17212b}.mc-field{display:flex;flex-direction:column;gap:6px;margin-top:12px}.mc-field.two{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.mc-field label{font-size:11px;font-weight:800;color:#687686}.mc-field input,.mc-field textarea{width:100%;box-sizing:border-box;border:1px solid rgba(23,33,43,.08);border-radius:16px;background:#fff;color:#17212b;padding:12px 14px;font-size:14px;outline:none;font-family:inherit}.mc-field textarea{resize:none;min-height:104px;line-height:1.7}.mc-editor-foot{display:flex;gap:10px;padding-top:14px}.mc-save,.mc-cancel{flex:1;height:44px;border-radius:14px;font-size:13px;font-weight:800}.mc-cancel{background:#eef2f6;color:#5a6977}.mc-save{background:#17212b;color:#fff}`;
    ...
    function buildShell() {
        ...
        app.innerHTML = `
<div class="mc-head"><button class="mc-back" data-mc="close"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18l-6-6 6-6"></path></svg></button><div class="mc-title"><div class="mc-title-main">记忆中枢</div><div class="mc-title-sub" id="mc-title-sub">把剧情、总结和记忆放进同一个入口</div></div><div class="mc-top"><button class="mc-top-btn ghost" data-mc="refresh">刷新</button><button class="mc-top-btn main" id="mc-primary" data-mc="primary">新增手记</button></div></div>
...
<div class="mc-editor" id="mc-editor"><div class="mc-editor-sheet"><div class="mc-editor-top"><div class="mc-editor-title" id="mc-editor-title">新增手记</div><button class="mc-act" data-mc="close-editor">关闭</button></div><div class="mc-field"><label for="mc-edit-title">标题</label><input id="mc-edit-title" type="text" placeholder="写一个醒目的标题"></div><div class="mc-field two hide" id="mc-time-row"><div><label for="mc-edit-date">日期</label><input id="mc-edit-date" type="date"></div><div><label for="mc-edit-time">时间</label><input id="mc-edit-time" type="time"></div></div><div class="mc-field hide" id="mc-place-row"><label for="mc-edit-place">地点</label><input id="mc-edit-place" type="text" placeholder="例如：咖啡店、公司楼下"></div><div class="mc-field"><label for="mc-edit-content" id="mc-edit-label">内容</label><textarea id="mc-edit-content" placeholder="把这条长期记忆写清楚。"></textarea></div><div class="mc-editor-foot"><button class="mc-cancel" data-mc="close-editor">取消</button><button class="mc-save" data-mc="save-editor">保存</button></div></div></div>`;
    ...
    function renderMemory() {
        ...
        var items = timeline();
        box.innerHTML = '<div class="mc-grid"><div class="mc-stat"><div class="mc-stat-v">' + state.summaries.length + '</div><div class="mc-stat-l">总结档案</div></div><div class="mc-stat"><div class="mc-stat-v">' + state.notes.length + '</div><div class="mc-stat-l">手动手记</div></div><div class="mc-stat"><div class="mc-stat-v">' + state.offline.length + '</div><div class="mc-stat-l">线下记录</div></div><div class="mc-stat"><div class="mc-stat-v">' + (state.online.length + state.offline.length) + '</div><div class="mc-stat-l">可追溯消息</div></div></div><div class="mc-card"><div class="mc-sec-title">最近片段</div><div class="mc-sec-desc">这里抓的是最近能快速定位关系状态和剧情走向的几段内容。</div>' + (lines.length ? '<div class="mc-lines">' + lines.map(function(item) { return '<div class="mc-line"><span class="mc-line-tag">' + esc(item.tag) + '</span><div class="mc-line-text">' + esc(short(item.text, 120)) + '</div></div>'; }).join('') + '</div>' : '<div class="mc-empty" style="margin-top:12px;">当前还没有足够的新近片段可展示。</div>') + '</div><div class="mc-card"><div class="mc-sec-title">记忆时间线</div><div class="mc-sec-desc">剧情片段会在上方展示，这里统一整理总结和手动记忆，方便补档和修正。</div>' + (items.length ? '<div class="mc-timeline">' + items.map(function(item) { return '<div class="mc-mini"><div class="mc-mini-top"><div><span class="mc-badge ' + (item.kind === 'summary' ? 'sum' : 'note') + '">' + (item.kind === 'summary' ? '总结' : '手记') + '</span><div class="mc-meta">' + esc(item.meta) + '</div></div><div class="mc-mini-act">' + (item.kind === 'summary' ? '<button class="mc-act" data-mc="edit-summary" data-index="' + item.index + '">编辑</button><button class="mc-act danger" data-mc="del-summary" data-index="' + item.index + '">删除</button>' : '<button class="mc-act" data-mc="edit-note" data-id="' + item.id + '">编辑</button><button class="mc-act danger" data-mc="del-note" data-id="' + item.id + '">删除</button>') + '</div></div><div class="mc-mini-title">' + esc(item.title) + '</div><div class="mc-mini-body">' + nl(item.body) + '</div></div>'; }).join('') + '</div>' : '<div class="mc-empty" style="margin-top:12px;">还没有任何记忆内容。可以先新增一条手记，或者去聊天详情推进剧情、生成总结。</div>') + '</div>';
    }
